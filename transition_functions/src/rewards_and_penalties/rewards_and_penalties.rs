...
//                 eligible_validator_indices.push(Validator(index));
//             }
//         }
        
//         //# Micro-incentives for matching FFG source, FFG target, and head
        
//         let matching_source_attestations = get_matching_source_attestations(self, previous_epoch);
//         let matching_target_attestations = get_matching_target_attestations(self, previous_epoch);
//         let matching_head_attestations = get_matching_head_attestations(self, previous_epoch);

//         for attestations in (matching_source_attestations, matching_target_attestations, matching_head_attestations) {
//             let unslashed_attesting_indices = get_unslashed_attesting_indices(self, attestations);
